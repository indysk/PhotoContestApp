...
ActiveRecord::Schema.define(version: 2021_08_23_031316) do
  ...
  create_table "contests", id: :string, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.string "user_id"
    t.datetime "created_at", null: false
  ...
  create_table "photos", id: :string, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.string "user_id"
    t.string "contest_id"
    t.datetime "created_at", null: false
  ...
  create_table "votes", id: :string, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
